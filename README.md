...
|-------------------|-------------------|----------------------|
| `apply_cat1`      | `yes`             | Correct CAT I findings |
| `apply_cat2`      | `no`              | Correct CAT II findings |
| `apply_cat3`      | `no`              | Correct CAT III findings |
...
| `selinux_policy` | `targeted`  | SELinux policy to apply |
